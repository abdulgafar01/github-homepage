    ...
    <div className='flex'>
        ...
        <div className= ' absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
            ...
            <form action="">
                ...
                <dl>
                    <dd>
                    <input className='bg-white h-12 focus:outline-none max-md:rounded-md md:rounded-s-md right-0 w-full placeholder:text-[16px] pl-3' placeholder="Email address" type="email" name="user_email" id="user_email" autoComplete="off" spellCheck="false"/>
                    </dd>
                </dl>
