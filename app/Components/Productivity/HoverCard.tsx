...
const HoverCard: React.FC<Props> = ({children, backgroundColor, direction, left}) => {
  ...
  return (
   <animated.div className="overflow-hidden  mb-3 md:mb-8 rounded-xl" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} style={{ transform: springProps.xys.to(trans) }}>
