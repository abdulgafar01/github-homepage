            ...
            <div className=''>
                <div className='overflow-x-auto pt-2 px-2 mb-0 border-b-[0.5px] border-[#30363d] '>
                    <div className='flex items-center bg-[#161b22] text-[#7d8590] tab-nav'>
                        <button onClick={() => {setShowPy(true); setShowGo(false); setShowJs(false)}} type='button' className={`flex items-center  py-2 px-4 cursor-pointer ${showPy ? "border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]" : ""}  `}>
                        ...
                        <button onClick={() => {setShowPy(false); setShowGo(false); setShowJs(true)}} type="button" className={`flex items-center py-2 px-4 cursor-pointer ${showJs ? "border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]": ""}`}>
                        ...
                        <button onClick={() => {setShowPy(false); setShowGo(true); setShowJs(false)}} type="button" className={`flex items-center py-2 px-4 cursor-pointer ${showGo ? "border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]": ""} `}>
